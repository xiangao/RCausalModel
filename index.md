...
`CausalModel` is an R port of the [Python CausalModel
package](https://github.com/freshtaste/CausalModel) from Qu et
al. (2021). It collects estimators for three settings I often teach
